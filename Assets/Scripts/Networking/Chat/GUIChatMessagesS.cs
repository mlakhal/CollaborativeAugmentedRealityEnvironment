...
public class GUIChatMessagesS : MonoBehaviour
{
	...
	public static GUIChatMessagesS SP;
	...
	void Awake()
	{
		window = new Rect(10, 270, width, height);
		SP = this;
	...
	void OnGUI()
	{
		...
		window = GUI.Window(5, window, GlobalChatWindow, "Chat. Communication");
	}
	...
	void GlobalChatWindow(int id)
	{
		...
		if (  GUILayout.Button("Send") && inputField.Length > 0)
		{
			HitEnter(inputField);
		}
	...
	{
		//msg = msg.Replace("\n", "");
		GetComponent<NetworkView>().RPC("ApplyGlobalChatText", RPCMode.AllBuffered, playerName, msg);
